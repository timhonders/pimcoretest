...
class KegaAmqp_Amqp_Writer
{
    ...
    {
        return array_map('chr', KegaAmqp_Amqp_Writer::bytesplit($x,$bytes));
    }
    ...
    {
        $this->flushbits();
        $this->out .= implode("", KegaAmqp_Amqp_Writer::chrbytesplit($n,4));
    }
    ...
    {
        $this->flushbits();
        $this->out .= implode("", KegaAmqp_Amqp_Writer::chrbytesplit($n,8));
    }
    ...
    */
    ...
    {
        $this->flushbits();
        $table_data = new KegaAmqp_Amqp_Writer();
        foreach($d as $k=>$va)
        {
            list($ftype,$v) = $va;
