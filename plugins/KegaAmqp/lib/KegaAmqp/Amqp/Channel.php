...
class KegaAmqp_Amqp_Channel extends KegaAmqp_Amqp_AbstractChannel
{
                                ...
                                $auto_decode=true)
    {
        ...
        if($this->debug)
        {
          KegaAmqp_Amqp_Tools::debug_msg("using channel_id: " . $channel_id);
        }
    ...
    protected function _close($args)
    {
        ...
        throw new KegaAmqp_Amqp_Exceptions_ChannelException($reply_code, $reply_text,
    ...
    protected function open_ok($args)
    {
        ...
        if($this->debug)
        {
         KegaAmqp_Amqp_Tools::debug_msg("Channel open");
        }
    }
