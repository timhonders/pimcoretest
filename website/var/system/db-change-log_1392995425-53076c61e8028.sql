...
ALTER TABLE `object_query_2` CHANGE COLUMN `qqq` `qqq` varchar(255) NULL;

/*--NEXT--*/

ALTER TABLE `object_store_2` CHANGE COLUMN `qqq` `qqq` varchar(255) NULL;
...
ALTER TABLE `object_query_2` ADD COLUMN `michiel` varchar(255) NULL;

/*--NEXT--*/

ALTER TABLE `object_store_2` ADD COLUMN `michiel` varchar(255) NULL;

/*--NEXT--*/

ALTER TABLE `object_query_2` DROP INDEX `p_index_michiel`;

/*--NEXT--*/

ALTER TABLE `object_store_2` DROP INDEX `p_index_michiel`;
