...
ALTER TABLE `object_query_1` ADD COLUMN `tim` varchar(255) NULL;

/*--NEXT--*/

ALTER TABLE `object_store_1` ADD COLUMN `tim` varchar(255) NULL;

/*--NEXT--*/

ALTER TABLE `object_query_1` DROP INDEX `p_index_tim`;

/*--NEXT--*/

ALTER TABLE `object_store_1` DROP INDEX `p_index_tim`;
